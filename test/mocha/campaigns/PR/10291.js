 ...
 * https://github.com/PrestaShop/PrestaShop/pull/10291
 */
...
scenario('This scenario is based on the bug described on his PR: https://github.com/PrestaShop/PrestaShop/pull/10291', client => {
  ...
  scenario('Check if the textarea of the meta description is correctly displayed', client => {
    ...
    test('should get the bounding box of "meta title input group"', () => client.getBoundingBox(Categories.input_group.replace('%D', 7), 1000, 'metaTitleInput'));
    test('should get the bounding box of "meta description input', () => client.getBoundingBox(Categories.input_group.replace('%D', 8), 1000, 'metaDescriptionInput'));
    test('should Check if the textarea of the meta description is correctly displayed', async() => {
      global.tab['metaTitleInput'].width === global.tab['metaDescriptionInput'].width ? global.correctlyDisplayed = true : global.correctlyDisplayed = false;
