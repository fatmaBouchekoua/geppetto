module.exports = {
  CheckoutOrderPage: {
    arrow_button_up: '#add-to-cart-or-refresh button.bootstrap-touchspin-up',
    ...
    product_price: '#main  span.product-price strong',
    total_cart_price: '#main div.cart-total span.value',
    gift_wrapped_checkbox: '#input_gift',
    total_price_checkout: '#js-checkout-summary div.cart-total span.value',
    subtotal_price: '#cart-subtotal-products  span.value',
    gift_wrapping_price: '#cart-subtotal-gift_wrapping  span.value'
  }
};
